...
$(document).ready(function () {
    // Click on "Modifier" = Hide modifier
    // Show buttons "Annuler" and "Enregistrer" + Show Name and Description fields + Delete Button
    $('#modifyDescription').click(function () {
        $(this).addClass("hidden");
        $('#deleteScenario').removeClass("hidden");
    ...
    $('#cancelDescription').click(function () {
        ...
        $('#deleteScenario').addClass("hidden");
    ...
    //href="{{route('scenario.delete', array('projectId'=>$projectId, 'stepId'=>$scenario->id))}}
})
